...
export function questionOrderFor(_attemptNumber: number, questionCount = 10) {
  return Array.from({ length: Math.max(1, questionCount) }, (_, index) => index);
}
...
const levelOneLaunchDiscoveries: BharatUdayDiscovery[] = [
  {
    prompt: "Who described Earth as rotating on its axis in the Aryabhatiya?",
    choices: ["Varahamihira", "Bhaskara II", "Brahmagupta", "Aryabhata"],
    answer: "Aryabhata",
    note: "Aryabhata described the apparent movement of the stars as an effect of Earth's rotation.",
  },
  {
    prompt: "Which is a balanced approach to wellbeing?",
    choices: ["One quick remedy", "Food, movement, rest and attention", "Only supplements", "Only intense exercise"],
    answer: "Food, movement, rest and attention",
    note: "Wellbeing is supported by several connected habits rather than one quick fix.",
  },
  {
    prompt: "What does a script provide?",
    choices: ["A system for writing language", "A system for measuring sound", "A list of word meanings", "A method of translating speech"],
    answer: "A system for writing language",
    note: "A language can be written in one or more scripts.",
  },
  {
    prompt: "What is a sacred grove?",
    choices: ["A community-protected patch of nature", "A commercial timber plantation", "A city recreation park", "A single protected tree"],
    answer: "A community-protected patch of nature",
    note: "Sacred groves often shelter locally important biodiversity.",
  },
  {
    prompt: "What is resonance?",
    choices: ["Sound disappearing in air", "Two unrelated notes cancelling forever", "Light bending through glass", "A strong response at a matching frequency"],
    answer: "A strong response at a matching frequency",
    note: "Resonance increases vibration when frequencies align.",
  },
  {
    prompt: "Which is safest during a simple breathing pause?",
    choices: ["Holding as long as possible", "Ignoring dizziness", "Comfort without strain", "Forcing the breath"],
    answer: "Comfort without strain",
    note: "Gentle awareness is preferable to forcing or prolonged retention.",
  },
  {
    prompt: "What separates white light into colours in a prism?",
    choices: ["Evaporation and condensation", "Refraction and dispersion", "Reflection and absorption", "Magnetism and conduction"],
    answer: "Refraction and dispersion",
    note: "Different wavelengths bend by different amounts.",
  },
  {
    prompt: "A short mindful pause trains which ability?",
    choices: ["Returning to the present", "Predicting the future", "Suppressing every thought", "Increasing muscular strength"],
    answer: "Returning to the present",
    note: "Mindfulness notices wandering and gently returns attention.",
  },
  {
    prompt: "When did the Constitution of India come into effect?",
    choices: ["15 August 1947", "26 November 1949", "2 October 1950", "26 January 1950"],
    answer: "26 January 1950",
    note: "The date is observed as Republic Day.",
  },
  {
    prompt: "Mangalyaan orbited which planet?",
    choices: ["Venus", "Jupiter", "Mercury", "Mars"],
    answer: "Mars",
    note: "The Mars Orbiter Mission entered Martian orbit in 2014.",
  },
];
...
bharatUdayLevels[0] = {
  ...bharatUdayLevels[0],
  title: "Level 01",
  realm: "Mixed discoveries",
  coachFact: "Ten questions connected culture, science and consciousness. Every completed level earns its certificate; there is no qualifying benchmark.",
  innerPrompt: "Carry one discovery from this level into the rest of your day.",
  discoveries: levelOneLaunchDiscoveries,
};
...
export function choicesFor(levelData: BharatUdayLevel, questionIndex: number, attemptNumber = 0) {
  const discovery = levelData.discoveries[questionIndex];
  const answer = discovery.answer;
  if (discovery.choices?.length === 4) return [...discovery.choices];
