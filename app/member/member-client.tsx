...
type Member = { id: string; fullName: string; email: string; mobile: string; city: string; interests: string; skills: string; sevaPreference: string; role: string };
