...
export function NextHumanBooksClient() {
  ...
  return <main className="nhb-page">
    ...
    {loading ? <section className="nhb-state">Opening your bookshelf…</section> : signedOut ? <section className="nhb-state"><p>MEMBER ACCESS</p><h2>Your books belong to your private account.</h2><span>Sign in to read Book Zero free, or create an account before purchasing Book One. Your purchase will remain available whenever you return.</span><div><Link className="nhb-primary" href="/member">Sign in</Link><Link href="/joincommunity">Create an account</Link></div></section> :
