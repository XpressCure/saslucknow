...
export default function LifeSketchPage() {
  return <div className="detail-page life-sketch-page">
    ...
    <main>
      ...
      <aside className="biography-source"><p className="kicker">ABOUT THIS LIFE SKETCH</p><p>This self-contained chronological account follows the factual sequence of the Sri Aurobindo Ashram photographic exhibition and presents it in original wording within the Lucknow Centre’s visual theme.</p></aside>
    </main>
