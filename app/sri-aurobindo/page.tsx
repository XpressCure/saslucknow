...
const sections = [
  ...
  { id: "on-himself", title: "On Himself", text: "Sri Aurobindo’s autobiographical observations illuminate the inner development behind his public life. They describe a Yoga formed through experience, struggle and discovery rather than a fixed system, and reveal how his poetry—especially Savitri—became a field for spiritual exploration.", href: "https://www.sriaurobindoashram.org/sriaurobindo/on_himself.php" },
  { id: "mother-on", title: "The Mother on Sri Aurobindo", text: "The Mother presents Sri Aurobindo’s work as a preparation for a new step in human evolution. Her recollections point to his vast peace, his pioneering exploration of the supramental consciousness, and the living unity of their spiritual work.", href: "https://www.sriaurobindoashram.org/sriaurobindo/mother_on.php" },
  { id: "writings", title: "Writings", text: "His writings range across philosophy, Yoga, social and political thought, poetry, literary criticism and cultural studies. Major works include The Life Divine, The Synthesis of Yoga, Essays on the Gita and Savitri. Together they offer a many-sided vision of consciousness, evolution and the future of humanity.", href: "https://www.sriaurobindoashram.org/sriaurobindo/writings.php" },
  { id: "translations", title: "Translations", text: "Sri Aurobindo translated and interpreted works from Sanskrit, Bengali, Greek and Latin traditions. His renderings sought to carry not merely literal meaning, but something of the original work’s rhythm, atmosphere and spiritual force.", href: "https://www.sriaurobindoashram.org/sriaurobindo/translations.php" },
];
