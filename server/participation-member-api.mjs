...
import { handleNextHumanChallengeMemberRequest } from "./next-human-challenge-api.mjs";
...
export async function handleMemberRequest({ request, response, url, db, organisationKey, readJson, readBuffer, sendJson, clientAddress }) {
  ...
  if (await handleNextHumanChallengeMemberRequest({ request, response, url, db, organisationKey, actor, readJson, sendJson })) return true;
