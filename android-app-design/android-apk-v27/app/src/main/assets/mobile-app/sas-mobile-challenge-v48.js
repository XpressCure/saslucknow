(function () {
  window.installSasMobileChallenge = function (doc) {
    ...
    style.textContent = [
      ...
      '#sas-app-redesign .sas-bum-video-toolbar{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px 4px 2px}',
      '#sas-app-redesign .sas-bum-video-replay{min-height:38px;padding:8px 13px;border:1px solid rgba(244,200,107,.62);border-radius:10px;background:#fff8e8;color:#082532;font-size:11px;font-weight:900;box-shadow:0 3px 0 #bb7b18}',
      '#sas-app-redesign .sas-bum-video-status{margin:0;color:#c8e3e8;font-size:9px;line-height:1.35;text-align:right}',
      ...
      '#sas-app-redesign .sas-bum-release-note{margin:13px 0 0;padding:11px 13px;border:1px solid rgba(255,211,103,.3);border-radius:12px;background:rgba(255,255,255,.06);color:#cfe2e7;font-size:10px;line-height:1.45}',
      ...
      '#sas-app-redesign .sas-bum-back{display:none!important}',
      ...
      '#sas-app-redesign .sas-bum-track{display:grid;grid-template-columns:repeat(10,1fr);gap:4px;margin-bottom:27px}',
      ...
      '#sas-app-redesign .sas-bum-sponsor-strip{align-items:center;display:flex;gap:9px;justify-content:center;margin:18px -20px -20px;padding:10px 14px;background:rgba(255,255,255,.94);color:#173d49}',
      '#sas-app-redesign .sas-bum-sponsor-strip>span{font-size:7px;font-weight:900;letter-spacing:.12em}',
      '#sas-app-redesign .sas-bum-sponsor-strip>div{align-items:center;display:flex;flex-wrap:wrap;gap:8px;justify-content:center}',
      '#sas-app-redesign .sas-bum-sponsor-strip img{height:25px;max-width:70px;object-fit:contain}',
      '#sas-app-redesign .sas-bum-sponsor-strip b{font-size:9px}',
    ...
    var dashboardTemplate = doc.getElementById('sas-screen-darshan');
    var dashboardChallengeCopy = dashboardTemplate && dashboardTemplate.content.querySelector('[data-dashboard-card="nextHumanChallenge"] p');
    if (dashboardChallengeCopy) dashboardChallengeCopy.textContent = 'Ten mixed discoveries are ready today. Complete Level 1 and receive your certificate.';
    var activeDashboardChallengeCopy = doc.querySelector('[data-dashboard-card="nextHumanChallenge"] p');
    if (activeDashboardChallengeCopy) activeDashboardChallengeCopy.textContent = 'Ten mixed discoveries are ready today. Complete Level 1 and receive your certificate.';

    template.innerHTML = [
      '<main class="sas-bum">',
      '<section class="sas-bum-video"><video data-bu-video-source="/public/bharat-uday/next-human-challenge-intro.mp4" controls autoplay muted playsinline preload="auto" poster="/public/bharat-uday/next-human-challenge-poster.jpg" aria-label="Introduction to The Next Human Challenge">Your device could not play the introduction video.</video><div class="sas-bum-video-toolbar"><button class="sas-bum-video-replay" type="button" data-bu-action="replay-video">Play introduction ▶</button><p class="sas-bum-video-status" data-bu-video-status aria-live="polite">A short introduction to the challenge.</p></div></section>',
      '<section class="sas-bum-hero"><div class="sas-bum-hero-copy"><span class="sas-bum-pill">A 30-LEVEL DISCOVERY EXPERIENCE</span><h1>The Next Human <span>Challenge</span></h1><p>Ten questions. One discovery. One life quote.</p><div class="sas-bum-proof"><span><b>30</b> vivid levels</span><span><b>10</b> questions each</span><span><b>∞</b> your pace</span></div></div></section>',
      '<div data-bu-stage="overview">',
      '<section class="sas-bum-section sas-bum-light sas-bum-discovery"><p class="sas-bum-kicker">NOT A TEST. A DISCOVERY.</p><h2>Culture meets science.<br><em>Knowledge meets you.</em></h2><p class="sas-bum-copy">The Next Human Challenge is a fast, free journey through 30 levels of mixed discoveries—from zero and space science to biodiversity, music, attention and the future human. Every completed level creates a certificate.</p><div class="sas-bum-flow"><article class="sas-bum-step"><span>01</span><strong>JÑĀNA</strong><p>Answer ten inviting questions</p></article><article class="sas-bum-step"><span>02</span><strong>KHOJ</strong><p>Unlock a surprising discovery</p></article><article class="sas-bum-step"><span>03</span><strong>INSIGHT</strong><p>Receive a word for life</p></article><article class="sas-bum-step"><span>04</span><strong>CERTIFICATE</strong><p>Celebrate every completed level</p></article></div></section>',
      ...
      '</div>',
      '<section class="sas-bum-stage" data-bu-stage="welcome" data-bu-hidden><button class="sas-bum-back" type="button" data-bu-action="overview">Return to the journey</button><div class="sas-bum-emblem" data-bu-welcome-symbol>✦</div><p class="sas-bum-kicker" data-bu-welcome-kicker>LEVEL 01</p><h2 data-bu-welcome-title>Level 01</h2><p data-bu-welcome-copy>Ten mixed-subject questions. One hundred possible marks. A certificate after completion.</p><div class="sas-bum-meta"><span>10 questions</span><span>100 marks</span><span>No qualifying benchmark</span></div><button class="sas-bum-primary" type="button" data-bu-action="enter-level">Enter this level →</button></section>',
      '<section class="sas-bum-stage" data-bu-stage="question" data-bu-hidden><div class="sas-bum-qhead"><button class="sas-bum-back" type="button" data-bu-action="welcome">Exit level</button><strong data-bu-question-count>1 / 10</strong></div><div class="sas-bum-track" data-bu-track></div><p class="sas-bum-kicker" data-bu-question-kicker>DISCOVERY QUESTION 1</p><h2 data-bu-question-prompt></h2><div class="sas-bum-options" data-bu-options></div><p class="sas-bum-feedback" data-bu-feedback data-bu-hidden></p><button class="sas-bum-primary" type="button" data-bu-action="next-question" data-bu-next disabled>Next question →</button></section>',
      '<section class="sas-bum-stage" data-bu-stage="coach" data-bu-hidden><div class="sas-bum-score"><div><span data-bu-score>0</span><small>OUT OF 100</small></div></div><p class="sas-bum-kicker">KHOJ · YOUR DISCOVERY</p><h2 data-bu-score-message>Level complete.</h2><p data-bu-score-detail>Your result is recorded without a pass or fail benchmark.</p><div data-bu-answers></div><button class="sas-bum-primary" type="button" data-bu-action="quote" data-bu-coach-action>Proceed to finish this level →</button></section>',
      ...
      '<section class="sas-bum-stage" data-bu-stage="certificate" data-bu-hidden><button class="sas-bum-back" type="button" data-bu-action="overview">Return to the journey</button><p class="sas-bum-kicker">LEVEL COMPLETE</p><h2 data-bu-certificate-ready>Your Certificate of Discovery is ready.</h2><div class="sas-bum-certificate" data-bu-certificate data-level-symbol="✦"><img class="sas-bum-certificate-logo" src="/public/society-logo-transparent.png" alt="Sri Aurobindo Society Lucknow logo" data-bu-certificate-logo><small>SRI AUROBINDO SOCIETY, LUCKNOW · THE NEXT HUMAN CHALLENGE</small><h3 data-bu-certificate-title>Certificate of Discovery</h3><p>This is to certify that</p><strong class="sas-bum-certificate-name" data-bu-certificate-name>Type your name</strong><p data-bu-certificate-level>has successfully completed Level 01 of The Next Human Challenge.</p><p class="sas-bum-certificate-date">Completed on <strong data-bu-certificate-date></strong></p><blockquote><span data-bu-certificate-quote>“All life is Yoga.”</span><small data-bu-certificate-author>— Sri Aurobindo</small></blockquote><div class="sas-bum-sponsor-strip" data-bu-sponsor-strip data-bu-hidden><span>POWERED BY</span><div data-bu-sponsors></div></div></div><label class="sas-bum-name">Name on your certificate<input type="text" maxlength="60" placeholder="Type your name" data-bu-name></label><button class="sas-bum-primary" type="button" data-bu-action="download-certificate" disabled>Download Certificate</button><button class="sas-bum-secondary" type="button" data-bu-action="share-certificate" disabled>Share Certificate</button><button class="sas-bum-secondary" type="button" data-bu-action="next-level" data-bu-next-level>Go to next level</button><p class="sas-bum-notice" data-bu-download-status data-bu-hidden></p></section>',
      '</main>'
    ].join('');
    var templateLevelToggle = template.content.querySelector('[data-bu-action="toggle-levels"]');
    if (templateLevelToggle) {
      templateLevelToggle.textContent = 'View open levels';
      templateLevelToggle.setAttribute('data-bu-hidden','');
      var releaseNote = doc.createElement('p');
      releaseNote.className = 'sas-bum-release-note';
      releaseNote.setAttribute('data-bu-release-note','');
      releaseNote.textContent = 'Only Level 1 is open. New levels will appear here after the administrator releases them.';
      templateLevelToggle.parentNode.insertBefore(releaseNote,templateLevelToggle);
    }

    var levelSymbols = ['✦','०','◉','≈','◇','अ','✺','♧','♪','∞','⌁','⚙','⌖','❋','☼','◎','⚖','↑','↗','⌘','☀','❝','▦','＋','?','◷','✣','◌','⌁','✺'];
    var levels = Array.from({ length:30 },function (_,index) {
      var number = index + 1;
      return [number,levelSymbols[index],'Mixed discoveries','Level ' + String(number).padStart(2,'0')];
    });
    var questionPool = [
    ...
    var levelCatalog = Array.isArray(win.sasBharatUdayMobileLevels)
      ...
      : Array.isArray(window.sasBharatUdayMobileLevels)
        ...
        : [];
    var allCuratedQuestions = levelCatalog.reduce(function (questions,level) {
      return questions.concat(Array.isArray(level.questions) ? level.questions : []);
    },[]);
    if (!allCuratedQuestions.length) allCuratedQuestions = questionPool.slice();
    var remoteChallengeLevels = {};
    var challengeSponsors = [];
    var levelOneOpensOn = '2026-08-31';
    var unscheduledOpensOn = '2099-12-31';
    var levelOneLaunchPrompts = [
      'Who described Earth as rotating on its axis in the Aryabhatiya?',
      'Which is a balanced approach to wellbeing?',
      'What does a script provide?',
      'What is a sacred grove?',
      'What is resonance?',
      'Which is safest during a simple breathing pause?',
      'What separates white light into colours in a prism?',
      'A short mindful pause trains which ability?',
      'When did the Constitution of India come into effect?',
      'Mangalyaan orbited which planet?'
    ];
    var storageKey = 'sas-mobile-next-human-progress-v2';
    var progress = {};
    ...
    progress.completionDates = progress.completionDates && typeof progress.completionDates === 'object' ? progress.completionDates : {};
    ...
    function getCertificateCopy(levelData) {
      ...
      return {
        ...
        body:'has successfully completed Level ' + String(levelData.number).padStart(2,'0') + ' of The Next Human Challenge, exploring culture, science and consciousness through ten questions.',
        label:'LEVEL ' + String(levelData.number).padStart(2,'0') + ' COMPLETED · ' + (progress.scores[levelData.number] || 0) + '/100',
        displayTitle:'Level ' + String(levelData.number).padStart(2,'0'),
        milestone:null
      };
    }

    function certificateDateFor(levelNumber) {
      var stored = progress.completionDates[levelNumber];
      var parsed = stored ? new Date(stored) : new Date();
      if (Number.isNaN(parsed.getTime())) parsed = new Date();
      return parsed.toLocaleDateString('en-IN',{ day:'2-digit',month:'long',year:'numeric' });
    }

    function certificateShareMessage(levelData) {
      return [
        'https://saslucknow.in/bharat-uday',
        '',
        'I have completed Level ' + String(levelData.number).padStart(2,'0') + ' — ' + levelData.title + ' in The Next Human Challenge 2026.',
        'This free 30-level journey brings together culture, science and consciousness through questions, discoveries and reflection.',
        'Each level offers something new to learn and a thought to carry into everyday life.',
        'Join the challenge, discover your next level and share the journey with others.'
      ].join('\n');
    }
    ...
    function mixedQuestionPool(number) {
      var start = ((number - 1) * 11) % allCuratedQuestions.length;
      return Array.from({ length:20 },function (_,index) {
        return allCuratedQuestions[(start + index * 7) % allCuratedQuestions.length];
      });
    }
    function indiaDateKey(date) {
      var parts = new Intl.DateTimeFormat('en-US',{ timeZone:'Asia/Kolkata',year:'numeric',month:'2-digit',day:'2-digit' }).formatToParts(date || new Date()).reduce(function (result,part) {
        result[part.type] = part.value;
        return result;
      },{});
      return parts.year + '-' + parts.month + '-' + parts.day;
    }
    function fallbackOpeningDate(number) { return number === 1 ? levelOneOpensOn : unscheduledOpensOn; }
    function levelOpeningDate(number) {
      var remote = remoteChallengeLevels[number];
      return remote && /^\d{4}-\d{2}-\d{2}$/.test(String(remote.opensOn || '')) ? remote.opensOn : fallbackOpeningDate(number);
    }
    function isLevelAvailable(number) {
      var remote = remoteChallengeLevels[number];
      if (remote && typeof remote.available === 'boolean') return remote.available;
      return levelOpeningDate(number) <= indiaDateKey();
    }
    function playableLevelNumber() {
      var openLevels = levels.map(function (level) { return level[0]; }).filter(isLevelAvailable);
      if (!openLevels.length) return 1;
      var firstIncomplete = openLevels.find(function (number) { return progress.completed.indexOf(number) < 0; });
      return firstIncomplete || openLevels[openLevels.length - 1];
    }
    function levelOneLaunchQuestions() {
      var selected = levelOneLaunchPrompts.map(function (prompt) {
        return allCuratedQuestions.find(function (question) { return question.prompt === prompt; });
      }).filter(Boolean);
      return selected.length === 10 ? selected : mixedQuestionPool(1).slice(0,10);
    }
    function getLevelData(number) {
      ...
      var remote = remoteChallengeLevels[number];
      var configuredQuestions = remote && (Array.isArray(remote.publishedQuestions) ? remote.publishedQuestions : Array.isArray(remote.questions) ? remote.questions : []);
      var remoteQuestions = configuredQuestions ? configuredQuestions.map(function (question) {
        return { prompt:question.prompt,answer:question.correctAnswer,choices:question.choices,note:question.note };
      }) : [];
      return {
        number:fallback[0], symbol:fallback[1], realm:'Mixed discoveries', title:fallback[3],
        accent:catalogLevel && catalogLevel.accent || '#f4a42c',
        coachFact:'Ten mixed-subject questions bring culture, science and consciousness into one level.',
        innerPrompt:'Pause and carry one discovery into your day.',
        quote:catalogLevel && catalogLevel.quote || { text:'All life is Yoga.',author:'Sri Aurobindo',source:'The Synthesis of Yoga' },
        questions:remoteQuestions.length === 10 ? remoteQuestions : number === 1 ? levelOneLaunchQuestions() : []
      };
    }
    function getActiveLevel() { return getLevelData(activeLevelNumber); }
    function startAttempt() {
      var activeQuestions = getActiveLevel().questions || [];
      attemptQuestions = activeQuestions.slice(0,10).map(function (question) {
        return { prompt: question.prompt, answer: question.answer, choices: question.choices.slice(), note: question.note };
      });
    ...
    function syncProgressFromServer() {
      return win.fetch('/api/participation/member/next-human-challenge/progress',{ credentials:'same-origin',cache:'no-store' }).then(function (response) {
        ...
        saveProgress();
        var page = activePage();
        if (page) { configureLevel(page,playableLevelNumber()); refreshOverview(page); }
      }).catch(function () {});
    }
    function syncConfigurationFromServer() {
      return win.fetch('/api/participation/member/next-human-challenge/configuration',{ credentials:'same-origin',cache:'no-store' }).then(function (response) {
        if (!response.ok) throw new Error('Challenge configuration is unavailable');
        return response.json();
      }).then(function (result) {
        var configuredLevels = Array.isArray(result && result.levels) ? result.levels : [];
        remoteChallengeLevels = configuredLevels.reduce(function (map,level) {
          map[Number(level.level)] = level;
          return map;
        },{});
        challengeSponsors = Array.isArray(result && result.sponsors) ? result.sponsors.filter(function (sponsor) { return sponsor.enabled !== false; }) : [];
        var page = activePage();
        if (page) { configureLevel(page,playableLevelNumber()); refreshOverview(page); }
      }).catch(function () {});
    }
    ...
    function configureLevel(page,number) {
      ...
      page.querySelector('[data-bu-welcome-kicker]').textContent = 'LEVEL ' + String(levelData.number).padStart(2,'0');
    ...
    function refreshOverview(page) {
      var playable = playableLevelNumber();
      var next = getLevelData(playable);
      var openLevels = levels.filter(function (level) { return isLevelAvailable(level[0]); });
      var visibleCompleted = progress.completed.filter(function (number) { return isLevelAvailable(number); });
      page.querySelector('[data-bu-completed]').textContent = String(visibleCompleted.length);
      page.querySelector('[data-bu-current-label]').textContent = 'OPEN NOW · LEVEL ' + String(next.number).padStart(2,'0');
      ...
      page.querySelector('[data-bu-current-action]').setAttribute('data-bu-level',String(playable));
      var levelToggle = page.querySelector('[data-bu-action="toggle-levels"]');
      var releaseNote = page.querySelector('[data-bu-release-note]');
      if (releaseNote) releaseNote.textContent = openLevels.length === 1 ? 'Only Level 1 is open. New levels will appear here after the administrator releases them.' : String(openLevels.length) + ' levels are open. Closed levels stay hidden until their administrator-selected release date.';
      if (levelToggle) {
        levelToggle.textContent = 'View open levels (' + String(openLevels.length) + ')';
        if (openLevels.length > 1) levelToggle.removeAttribute('data-bu-hidden');
        else levelToggle.setAttribute('data-bu-hidden','');
      }
      page.querySelector('[data-bu-levels]').innerHTML = openLevels.map(function (level) {
        var done = progress.completed.indexOf(level[0]) >= 0;
        var current = level[0] === playable;
        var state = done ? 'complete' : current ? 'current' : '';
        var label = done ? '✓ Completed · View certificate' : current ? 'Begin this level →' : 'Open now';
        return '<button type="button" class="sas-bum-level ' + state + '" data-bu-action="open-level" data-bu-level="' + level[0] + '"><span class="sas-bum-level-number">' + String(level[0]).padStart(2,'0') + '</span><span class="sas-bum-level-symbol">' + level[1] + '</span><span class="sas-bum-level-copy"><small>' + level[2] + '</small><strong>' + level[3] + '</strong><b>' + label + '</b></span></button>';
      }).join('');
    }
    function renderQuestion(page) {
      var question = attemptQuestions[questionIndex];
      page.querySelector('[data-bu-question-count]').textContent = String(questionIndex + 1) + ' / 10';
      ...
      next.textContent = questionIndex === attemptQuestions.length - 1 ? 'Reveal my result →' : 'Next question →';
    }
    function renderCoach(page) {
      var levelData = getActiveLevel();
      var correctAnswers = answers.reduce(function (total, answer, index) { return total + (answer === attemptQuestions[index].answer ? 1 : 0); },0);
      ...
      page.querySelector('[data-bu-score-message]').textContent = 'Level ' + String(levelData.number).padStart(2,'0') + ' is complete.';
      page.querySelector('[data-bu-score-detail]').textContent = 'You scored ' + score + ' out of 100. Every completed level earns its certificate; there is no qualifying benchmark.';
      ...
      coachAction.setAttribute('data-bu-action','quote');
      coachAction.textContent = 'Proceed to finish this level →';
      saveAttemptToServer(levelData,score).then(function () {
        page.querySelector('[data-bu-score-detail]').textContent += ' Your ten answers are saved to your member account.';
      }).catch(function () {
    ...
    function refreshCertificate(page) {
      ...
      page.querySelector('[data-bu-certificate-date]').textContent = certificateDateFor(levelData.number);
      ...
      var levelSponsors = challengeSponsors.filter(function (sponsor) {
        return Array.isArray(sponsor.levelIds) && sponsor.levelIds.map(Number).indexOf(levelData.number) >= 0;
      });
      var sponsorStrip = page.querySelector('[data-bu-sponsor-strip]');
      var sponsorHost = page.querySelector('[data-bu-sponsors]');
      sponsorHost.innerHTML = levelSponsors.map(function (sponsor) {
        return sponsor.logo && sponsor.logo.url ? '<img src="' + sponsor.logo.url + '" alt="' + sponsor.name + '">' : '<b>' + sponsor.name + '</b>';
      }).join('');
      if (levelSponsors.length) sponsorStrip.removeAttribute('data-bu-hidden');
      else sponsorStrip.setAttribute('data-bu-hidden','');
      ...
      page.querySelector('[data-bu-action="share-certificate"]').disabled = !participantName;
      var nextButton = page.querySelector('[data-bu-next-level]');
      nextButton.textContent = levelData.number < 30 && isLevelAvailable(levelData.number + 1) ? 'Go to next level →' : 'More levels coming soon →';
    }
    function downloadCertificate(page) {
      ...
      function renderAndSave(logo) {
        ...
        context.fillStyle = 'rgba(255,255,255,.78)'; context.font = '700 20px Arial'; context.fillText('COMPLETED ON ' + certificateDateFor(levelData.number).toUpperCase(),540,930);
        context.fillStyle = 'rgba(255,255,255,.68)'; context.font = '700 18px Arial'; context.fillText('THE NEXT HUMAN CHALLENGE · GOMTI NAGAR CENTRE (UC-02)',540,972);
    ...
    function shareCertificate(page) {
      var levelData = getActiveLevel();
      var message = certificateShareMessage(levelData);
      var title = 'The Next Human Challenge 2026 — Level ' + String(levelData.number).padStart(2,'0');
      var bridge = win.SasAndroid || win.parent?.SasAndroid || win.parent?.parent?.SasAndroid;
      if (bridge && typeof bridge.shareText === 'function') {
        bridge.shareText(title,message);
      } else if (win.navigator.share) {
        win.navigator.share({ title:title,text:message }).catch(function () {});
      } else if (win.navigator.clipboard) {
        win.navigator.clipboard.writeText(message).catch(function () {});
      }
      var status = page.querySelector('[data-bu-download-status]');
      status.textContent = 'Certificate message is ready to share.';
      status.removeAttribute('data-bu-hidden');
    }
    function updateIntroVideoUi(page,state,message) {
      var replayButton = page && page.querySelector('[data-bu-action="replay-video"]');
      var status = page && page.querySelector('[data-bu-video-status]');
      if (replayButton) replayButton.textContent = state === 'playing' ? 'Restart introduction ↻' : 'Replay introduction ▶';
      if (status && message) status.textContent = message;
    }
    function playIntroVideo(page,restart) {
      var introVideo = page && page.querySelector('.sas-bum-video video');
      if (!introVideo) return;
      var videoSource = introVideo.getAttribute('data-bu-video-source');
      if (!introVideo.getAttribute('src') && videoSource) {
        introVideo.src = videoSource;
        introVideo.load();
      }
      introVideo.muted = true;
      if (restart) {
        try { introVideo.currentTime = 0; } catch (error) {}
      }
      var playback = introVideo.play();
      if (playback && typeof playback.then === 'function') {
        playback.then(function () {
          updateIntroVideoUi(page,'playing','Introduction playing · sound can be enabled in the player.');
        }).catch(function () {
          updateIntroVideoUi(page,'ready','Tap Replay introduction to begin.');
        });
      }
    }
    function prepare() {
      ...
      if (introVideo) {
        ...
        introVideo.addEventListener('ended',function () {
          updateIntroVideoUi(page,'ended','Introduction complete · the final message remains on screen.');
        });
        introVideo.addEventListener('error',function () {
          updateIntroVideoUi(page,'ready','Video could not start automatically. Tap Replay introduction.');
        });
        var videoSource = introVideo.getAttribute('data-bu-video-source');
        if (videoSource) {
          win.fetch(videoSource,{ cache:'force-cache' }).then(function (response) {
            ...
            introVideo.load();
            playIntroVideo(page,true);
          }).catch(function () {
            introVideo.src = videoSource;
            introVideo.load();
            introVideo.addEventListener('loadeddata',function () { playIntroVideo(page,true); },{ once:true });
          });
        }
      }
      configureLevel(page,playableLevelNumber());
    ...
    app.addEventListener('click',function (event) {
      ...
      if (action === 'replay-video') { playIntroVideo(page,true); return; }
      ...
      if (action === 'complete-level') {
        ...
        if (!progress.completionDates[activeLevelNumber]) progress.completionDates[activeLevelNumber] = new Date().toISOString();
      ...
      if (action === 'toggle-levels') {
        ...
        var openCount = levels.filter(function (level) { return isLevelAvailable(level[0]); }).length;
        button.textContent = expanded ? 'View open levels (' + String(openCount) + ')' : 'Hide open levels';
      ...
      if (action === 'open-level') {
        ...
        if (isLevelAvailable(number)) {
          configureLevel(page,number);
          if (progress.completed.indexOf(number) >= 0) showStage(page,'certificate');
          else showStage(page,'welcome');
        }
      }
      if (action === 'next-level') {
        var nextNumber = Math.min(30,activeLevelNumber + 1);
        if (activeLevelNumber >= 30 || !isLevelAvailable(nextNumber)) showStage(page,'overview');
        else { configureLevel(page,nextNumber); showStage(page,'welcome'); }
      }
      if (action === 'download-certificate') { recordCertificateDownload(activeLevelNumber); downloadCertificate(page); }
      if (action === 'share-certificate') shareCertificate(page);
    });
    ...
    win.sasHandleSystemBack = function () {
      ...
      if (page) {
        ...
        if (host && !host.hasAttribute('data-bu-hidden')) {
          ...
          var openCount = levels.filter(function (level) { return isLevelAvailable(level[0]); }).length;
          toggle.setAttribute('aria-expanded','false'); toggle.textContent = 'View open levels (' + String(openCount) + ')';
          return true;
        }
      }
