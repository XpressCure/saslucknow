...
try {
  ...
  await Promise.all([
    ...
    db.collection("nextHumanVolunteerInquiries").createIndex({ organisationKey: 1, reference: 1 }, { unique: true }),
    db.collection("nextHumanVolunteerInquiries").createIndex({ organisationKey: 1, status: 1, createdAt: -1 }),
    db.collection("nextHumanVolunteerInquiries").createIndex({ organisationKey: 1, normalisedMobile: 1 }),
    db.collection("nextHumanVolunteerInquiries").createIndex({ organisationKey: 1, normalisedEmail: 1 }, { sparse: true }),
    db.collection("nextHumanVolunteerInquiries").createIndex({ organisationKey: 1, source: 1, createdAt: -1 }),
